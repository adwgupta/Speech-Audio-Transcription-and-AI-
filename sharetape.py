...
class Sharetape:
    def __init__(
        ...
        # Initialize Sharetape object with necessary parameters
        self.video = video
        self.audio = audio
    ...
    def save_data(self, data):
        # Save words data to a JSON file
    ...
    def handle_speech_2_text(self):
        # Read stereo audio data from WAV file
        ...
        # Compute average of left and right channels to get mono audio
        ...
        # Open mono audio WAV file for recognition
        ...
        # Initialize KaldiRecognizer for speech-to-text
